...
import static com.accellion.moviecompanion.util.Constants.DEFAULT_VALUE;
...
public class ResultsItem implements Parcelable {
	...
	public String getOverview(){
		return overview != null && !overview.equalsIgnoreCase("") ? overview : DEFAULT_VALUE;
	}
	...
	public String getTitle(){
		return title != null && !title.equalsIgnoreCase("") ? title : DEFAULT_VALUE;
	}
